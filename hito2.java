...
public class hito2 {
    ...
    // A traves de esta clase nos conectamos a la base de datos de cine_danielbarrera
    public static void mostrarPeliculas() {
        String url = "jdbc:mysql://localhost:3306/cine_danielbarrera";  // Ponemos la direccion en la que tenemos guardada la base de datos
